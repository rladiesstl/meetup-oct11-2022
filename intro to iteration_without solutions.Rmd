...
It computes a measure or a function for each factor variable in a vector. It loops over all of the different values that appear in the INDEX variable.

The tapply() function constructs the subset of X that corresponds to that group, and then applies the function FUN to that subset of the data.
